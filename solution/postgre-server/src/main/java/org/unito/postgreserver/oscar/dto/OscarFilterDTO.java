...
public class OscarFilterDTO {
    ...
    @Schema(description = "Filter by the number of the ceremony greater than the specified value.", example = "50", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private Integer numberCeremonyGT;

    @Schema(description = "Filter by the number of the ceremony less than the specified value.", example = "75", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(description = "List of categories for the Oscar nominations.", example = "[\"Best Picture\"]", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private List<String> category;

    @Schema(description = "List of nominee names.", example = "[\"Leonardo DiCaprio\"]", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private List<String> nomineeName;

    @Schema(description = "List of movies nominated for the Oscar.", example = "[\"The Revenant\"]", requiredMode = Schema.RequiredMode.NOT_REQUIRED)

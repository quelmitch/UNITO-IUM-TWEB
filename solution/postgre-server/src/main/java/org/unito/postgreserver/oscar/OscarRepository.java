...
interface OscarRepository extends JpaRepository<OscarCeremony, Integer>, JpaSpecificationExecutor<OscarCeremony> {
    ...
    List<OscarCeremony> getWinnersByCeremonyYearOrNumber(@RequestParam(value = "year", required = false) Integer year, @RequestParam(value = "number", required = false) Integer number);
